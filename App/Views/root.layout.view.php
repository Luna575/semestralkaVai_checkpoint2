        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 mb-md-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-dark" href="<?= $link->url("ideas.index")?>" data-bs-toggle="dropdown" aria-expanded="false">Ideas</a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?= $link->url("ideas.index")?>"><i >lass="bi bi-file-image"></i> Pictures</a></li>
                    </ul>
                </li>
                <li><a href="<?= $link->url("ideas.index")?>" class="nav-link text-dark">About</a></li>
            </ul>
